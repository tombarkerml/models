...
#     examples_frames = vggish_input.wavfile_to_frames(wav_file)
# else:
...
# locate input and output tensors.
    ...
    for i in range(0,num_example_to_gen):
        ...
        audio_frames = mel_features.frame(example_waveform, int(0.96*16000), int(0.96*16000))
    ...
    embeddings_array= np.reshape(embeddings_array, (-1, embeddings_list[0].shape[1]))
    #reshape
    np.savez('features/features9', embeddings_array=embeddings_array, frames_array=frames_array)
